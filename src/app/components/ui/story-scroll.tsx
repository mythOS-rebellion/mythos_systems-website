...
export const FlowSection: React.FC<FlowSectionProps> = ({
  ...
  >
    <div
      data-flow-inner
      className={cx(
        'flow-art-container relative flex min-h-screen w-full flex-col justify-between gap-6 px-[5vw] pt-28 pb-[5vw]',
...
const FlowArt: React.FC<FlowArtProps> = ({ children, className, 'aria-label': ariaLabel = 'Story scroll' }) => {
  ...
  useEffect(() => {
    ...
    // gsap.context scopes the selectors + auto-reverts every tween/ScrollTrigger
    // created inside it when the page unmounts (clean SPA navigation).
